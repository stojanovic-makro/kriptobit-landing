  ...
  <div class="main-page-wrapper">
    ...
    <main>
      <section style="padding-top: 145px; padding-bottom: 128px">
        <div>
          <p style="font-family: 'Atyp Display Medium'; font-size: 64px; line-height: 92px; margin-top: 0">About</p>
          <p style="max-width: 744px" class="t1">About page.</p>
        </div>
      </section>
    </main>
  </div>
